 ...
 * @Date: 2023-04-19 11:26:29
 * @LastEditors: yaohengfeng 1921934563@qq.com
 * @LastEditTime: 2023-04-20 16:31:07
 * @FilePath: \image-editor\src\js\ui\tools\bgcolor.js
...
const PICKER_COLOR = ['#000000', '#ffffff', ''];

/**
 * BGCOlor control class
 * @class
 * @ignore
 */
class BGCOlor {
  constructor(
    ...
    // this._makeBGButtonElement(defaultColor);
   ...
   * @private
   */
  _makeBGButtonElement(defaultColor) {
  ...
  _addEvent() {
    ...
    this.eventHandler = {
      pickerToggle: this._colorToggleEventHandler.bind(this),
  ...
  _colorToggleEventHandler(event) {
    const b = parseInt(this.colorElement.style.backgroundColor.substring(4, 5), 10) || 0;
    const bgColor = b === 0 ? 'rgb(255, 255, 255)' : 'rgb(0, 0, 0)';
    // const bgColorHX = b === 0 ? '#000000' : '#ffffff';
    this.colorElement.style.backgroundColor = bgColor;
    // const changeColoroBtn = document.querySelector(
    //   '#tui-image-editor > div.tui-image-editor-main-container > div.tui-image-editor-header > div.tui-image-editor-header-buttons > button'
    // );
    // changeColoroBtn.click();

    // setTimeout(() => {
    //   this.fire('change', bgColorHX);
    //   // this.picker = tuiColorPicker.create({
    //   //   container: this.pickerElement,
    //   //   preset: PICKER_COLOR,
    //   //   color: bgColorHX,
